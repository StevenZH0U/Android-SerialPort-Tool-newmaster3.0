...
public class RadioDialog implements View.OnClickListener {
    ...
    public RadioDialog(Activity context) {
        // 首先得到整个View
                    ...
                    if (Utils.isFastClick()) {
                        ...
                        new Thread() {
                            ...
                            public void run() {
                                ...
                                try {
                                    recordid = lg.addjuiceByPost("001", 1, 1, 1, 1, zhifu);
                                    Log.e("返回数据", recordid);
                                    if (recordid != null) {
                                ...
                                c.runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        if (erweima != null | erweima != "") {
                                            ...
                                            PriceDialog pd = new PriceDialog(c, erweima, String.valueOf(zhifu), String.valueOf(price), recordid, wendu, 1);
                                            pd.show();
                                            mRadioDialog.dismiss();
