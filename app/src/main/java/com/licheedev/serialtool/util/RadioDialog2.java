...
public class RadioDialog2 implements View.OnClickListener {
    Dialog mRadioDialog;
    ...
    public RadioDialog2(Activity context) {
        // 首先得到整个View
                ...
                if (wendu.equals("")) {
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            try {
                                recordid = lg.addjuiceByPost("001", 1, 1, 1, 2, zhifu);
                                Log.e("返回数据", recordid);
                                if (recordid != null) {
                            ...
                            c.runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if (erweima != null | erweima != "") {
                                        ...
                                        PriceDialog pd = new PriceDialog(c, erweima, String.valueOf(zhifu), String.valueOf(price), recordid, wendu, 2);
                                        pd.show();
                                        mRadioDialog.dismiss();
